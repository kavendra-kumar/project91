...
$('.demo-panel-bx').slimScroll({
  ...
  // Close
    ...
    $(document).on('click', '.box-btn-slide', function(){
      $(this).toggleClass('rotate-180').parents('.box').find('.box-content, .box-body-2').slideToggle();
    });

    $(document).on('click', '.box-btn-slide-1', function(){
      $(this).toggleClass('rotate-180').parents('.box').find('.box-content, .box-body-1').slideToggle();
    });
