		...
		<section class="content">
			<div class="row">	
				<div class="col-xl-9 col-lg-8 col-12">
					...
					<div class="box">
					<div class="box-header with-bordery">
						<h3 class="box-title">Admin Calendar</h3>
						</div>
						<div class="box-body">
						...
						<div id="event-1" class="tab-pane active">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<div class="input-group">
										  <input type="text" name="event_start_end_date" class="form-control" id="new_reservation" value="" required="">	
										  <div class="input-group-addon">
							...
							<div id="event-1">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<div class="input-group">
											  <input type="text" name="event_start_end_date" class="form-control" id="new_reservation1" required="">	
											  <div class="input-group-addon">
												<i class="fa fa-calendar"></i>
											  </div>	
											</div>
...
<script src="<?php echo base_url('assets/js/pages/calendar-admin.js');?>"></script>
...
<script type="text/javascript">
	 ...
	 //Date range picker
	 $('#new_reservation').daterangepicker({
     locale: {
        format: 'YYYY-MM-DD'
      },
	...
	$("#create_event").click(function () {
	    ...
	    $('.create-category').find("#new_reservation").prop('required',true);
