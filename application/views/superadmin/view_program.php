...
<head>
    ...
    <title><?php echo $cycle_name; ?> | <?php echo $title_name; ?> | Super Admin | Project91</title>
    <!-- Vendors Style-->
        ...
        <div class="col-xl-12 col-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $pro_del->name; ?></h3>
              <button data-toggle="modal" data-target="#add-program_cycle" class="float-right waves-effect waves-light btn btn-rounded btn-primary">Add Subject</button>
            </div>
            <div class="box-body">
                  ...
                  <tbody>
                    ...
                    if($program_cycle){
                      ...
                      foreach ($program_cycle as $mo) {
                        ...
                        ?>
                        <tr class="show-program_cycle<?php echo $mo->id; ?>">
                          <!-- <td><?php echo $cnt; ?></td> -->
                          ...
                          <td class="text-left">
                            <a onclick="editProgramCycle(<?php echo $mo->id; ?>);" href="javascript:void(0);" title="Edit"><i class="fa fa-edit text-primary font-size-20 mr-5"></i></a>
                            <a onclick="deleteProgramCycle(<?php echo $mo->id; ?>);" href="javascript:void(0);" title="Delete"><i class="fa fa-trash text-danger font-size-20"></i></a>
                          </td>
                        </tr>
                        <?php
                        $cnt++;
...
<!-- /.content-wrapper -->
<!--Start Modal Add Program Cycle-->
<div id="add-program_cycle" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <form method="POST" name="add_program_cycle_form" id="add_program_cycle_form" class="add_program_cycle_form" autocomplete="off" enctype="multipart/form-data">        
            ...
            <div class="box-footer text-center">
              <input type="hidden" name="pid" value="<?php echo $pro_del->id; ?>">
              <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
              <button type="submit" id="add_program_cycle_submit" class="btn btn-primary">Save</button>
              <img id="add_program_cycle_loader" style="visibility: hidden;" src="<?php echo base_url('assets/images/loading.gif'); ?>">
            </div>  
          </form>              
      </div>
  </div>
</div>
<!-- End Modal Add Program Cycle-->
<!--Start Modal Edit Program Cycle-->
<div id="edit-program_cycle" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
  <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
          ...
          <form method="POST" name="edit_program_cycle_form" id="edit_program_cycle_form" class="edit_program_cycle_form" autocomplete="off" enctype="multipart/form-data">        
            <div class="modal-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
            ...
            <div class="box-footer text-center">
              ...
              <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
              <button type="submit" id="edit_program_cycle_submit" class="btn btn-primary">Update</button>
              <img id="edit_program_cycle_loader" style="visibility: hidden;" src="<?php echo base_url('assets/images/loading.gif'); ?>">
            </div>  
          </form>              
      </div>
  </div>
</div>
<!-- End Modal Edit Program Cycle-->
